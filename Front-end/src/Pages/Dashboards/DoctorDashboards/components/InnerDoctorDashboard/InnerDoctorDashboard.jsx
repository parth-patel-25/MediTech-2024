        ...
        <div className='between-section'>
            <div className='titleHealth'>
                ...
                <div className='patientInputBox'>
                    <input type="text" placeholder='Find your patient here..'/>
...
export default InnerDoctorDashboard